O script cloud-init.sh é um script que foi criado para baixar e preparar uma imagem personalizada para ser usada com o Proxmox Virtual Environment (Proxmox VE). 
